...
Проект генерирует случайное количество магазинов в которых были сегодня продажи. 
Затем генерирует случайное количество касс в этих магазинах в которых сегодня были продажи. 
Затем генерирует случайное количество чеков и случайное количество позиций в каждом чеке. 
Данные генерируются (эмуляция работы касс), загружаются в MinIO (S3-совместимое хранилище),
каждый день в 23:00 кроме воскресенья, далее поступают в PostgreSQL каждый день в 23:30 для анализа 
и визуализируются через Metabase.
